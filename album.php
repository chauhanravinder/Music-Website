    ...
    <section>
      <!-- left side start-->
		...
		<!-- //header-ends -->
					...
					<!--//pop-up-box -->
						<div class="browse">
								<div class="tittle-head two">
									<h3 class="tittle">Album categories</h3>
			...
			<a href='balbum.php?acid=$x[1]'><img src='images/$x[2]' width='200' height='150' border='0'></a>
			<a href='balbum.php?acid=$x[1]'>$x[0]</font></b><h3></a>
