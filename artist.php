			...
			<div id="page-wrapper">
				<div class="inner-content">
					...
					<!--//pop-up-box -->
						...
						$q="select * from artist order by rand()";
						$res=mysqli_query($conn,$q) or die("Error in query " . mysqli_error($conn));
						$cnt=mysqli_affected_rows($conn);
						if($cnt==0)
						{
							print "<h1 align='center'><font color='red'>No song available</font></h1>";
						}
						else
						{
							while($x=mysqli_fetch_array($res))
							{
								...
								<a href='artistsong.php?arid=$x[3]'><img src='images/$x[2]' width='180' height='180' border='0'></a>
			
                        <br/>
                         <a href='artistsong.php?arid=$x[3]'> <h1>$x[1]</h1></a><br/><br/><br/>
							</div>";
