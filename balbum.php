			...
			<div id="page-wrapper">
				<div class="inner-content">
					...
					<!--//pop-up-box -->
						...
						$q="select * from album where albumcatid='$albumid'";
						...
						else
						{
							while($x=mysqli_fetch_array($res))
							{
								...
								<a href='albumsong.php?alid=$x[3]'><img src='images/$x[2]' width='225' height='160' border='0'></a>
			
                        <br/>
                         <a href='albumsong.php?alid=$x[3]'> <h1>$x[1]</h1></a><br/><br/><br/>
							</div>";
