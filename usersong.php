    ...
    <section>
      <!-- left side start-->
		...
		<!-- //header-ends -->
					...
					<!--//pop-up-box -->
						<div class="albums">
								<div class="tittle-head">
									<h3 class="tittle">User uploads</h3>
			...
			$q="select * from approve";
	        $res=mysqli_query($conn,$q) or die("Error in query" . mysqli_error($conn));
			$cnt=mysqli_affected_rows($conn);
			mysqli_close($conn);
			if($cnt==0)
			{
				print "<h3 align='center'><font color='red'>No records found</font></h3>";
			}
			else
			{
			...
			<a href='uploadedsongs/$x[2]' target='_blank' ><img src=images/$x[4] width='150'></a>			
		
			<a href='uploadedsongs/$x[2]' target='_blank' ><h3><b>$x[1]</b><h3></a>
						
                         <a href='uploadedsongs/$x[2]' download='$x[2]'>Download</a>
                        <br/>
                          <a href='uploadedsongs/$x[2]' target='_blank' >Listen now</a>
                        <br/><br/>
