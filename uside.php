<ul class="nav nav-pills nav-stacked custom-nav">
				...
				<li><a href="songs.php">
					...
					<i class="	fa fa-dot-circle-o"></i> <span>Albums</span></a>
						...
						?> 
						<li><a href="supload.php"><i class="fa fa-arrow-circle-up"></i> <span>Upload my song</span></a></li>
						
						
                        <li><a href="contact.php"><i class="fa fa-phone"></i><span>Contact Us</span></a> 
						<li><a href="feedback.php"><i class="fa fa-thumb-tack"></i><span>Feedback</span></a>                              </li>
