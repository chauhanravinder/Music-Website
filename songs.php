					...
					<!--//pop-up-box -->
						<div class="albums">
						  <div class="tittle-head">
									<h3 class="tittle">Top 10 songs</h3>
						...
						else
						{
							while($x=mysqli_fetch_array($res))
							{
								...
								<a href='palbum.php?acid=$x[1]'><img src='images/$x[2]' width='200' height='150' border='0'></a>
			<a href='palbum.php?acid=$x[1]'>$x[0]</font></b><h3></a>
