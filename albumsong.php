    ...
    <section>
      <!-- left side start-->
		...
		<!-- //header-ends -->
					...
					<!--//pop-up-box -->
						<div class="browse">
								<div class="tittle-head two">
									<h3 class="tittle">Albums Songs</h3>
						...
						$q="select * from music where album='$alid'";
						$res=mysqli_query($conn,$q) or die("Error in query " . mysqli_error($conn));
						$cnt=mysqli_affected_rows($conn);
						if($cnt==0)
						{
							print "<h3 align='center'><font color='red'>No song available</font></h3>";
						}
						else
						{
			...
			<a href='uploadedsongs/$x[1]' target='_blank' ><h3><b><font color='black'>$x[2]</font></b><h3></a>
